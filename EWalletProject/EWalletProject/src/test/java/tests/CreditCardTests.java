...
public class CreditCardTests {
    ...
    public void creditCardLimitLowTest(){
        try {
            CreditCard cc = new CreditCard("Joe", "39472398", new CustomDate("12/12"), "320", 400);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void creditCardLimitHighTest(){
        try {
            CreditCard cc = new CreditCard("Joe", "39472398", new CustomDate("12/12"), "320", 5100);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void withdrawTrueTest(){
        CreditCard cc = new CreditCard("Joe", "39472398", new CustomDate("12/12"), "320", 4000);
