...
public class WalletTests {
    ...
    public void deleteCreditCardTest(){
        Wallet w = new Wallet();
        CreditCard cc = new CreditCard("", "10032", new CustomDate("12/11"), "123", 700);
        w.add(cc);
    ...
    public void deleteNoteTest(){
        Wallet w = new Wallet();
        Note n = new Note(new CustomDate("10/21"), "Hello");
        w.add(n);
        assertEquals(2, w.getWallet().size());
    ...
    public void browseNotesTest(){
        Note n = new Note(new CustomDate("10/21"), "Hello 1");
        Note n2 = new Note(new CustomDate("11/22"), "Hello 2");
        Note n3 = new Note(new CustomDate("12/23"), "Hello 3");
        Wallet w = new Wallet();
        w.add(n);
        w.add(n2);
        w.add(n3);
    ...
    public void getPaymentCardsTest(){
        Wallet w = new Wallet();
        w.add(new CreditCard("", "3212321", new CustomDate("23/11"), "321", 549));
        w.add(new DebitCard("", "321545", new Bank(7000)));
        w.add(new CreditCard("", "32655", new CustomDate("23/12"), "657", 503));
